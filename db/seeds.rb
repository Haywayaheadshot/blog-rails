...
@post_1 = Post.create(title: 'Hello', text: 'Greetings from Peru', author_id: 1)
@post_2 = Post.create(title: 'Hello', text: 'Greetings from Togo', author_id: 1)
@post_3 = Post.create(title: 'Hello', text: 'Greetings from Ghana', author_id: 1)
@post_4 = Post.create(title: 'Hello', text: 'Greetings from Mali', author_id: 1)
Comment.create( author_id: 1, post_id: @post_1.id, text: 'First Comment')
Comment.create( author_id: 1, post_id: @post_2.id, text: 'So am I')
Comment.create( author_id: 1, post_id: @post_3.id, text: 'You are so handsome')
Comment.create( author_id: 1, post_id: @post_4.id, text: 'I respect you')
# rails db:seed
