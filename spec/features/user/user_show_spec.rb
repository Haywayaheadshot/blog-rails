...
RSpec.describe 'UserController', type: :system do
  before(:each) do
    # Create users
    @user = User.create(name: 'Anthony', photo: 'https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg?auto=compress&cs=tinysrgb&w=800', bio:
    'Lorem ipsum dolor sit amet sss labore fugiat!.', posts_counter: 3)
    @post_one = Post.create(author_id: @user.id, title: 'The jungle', text: 'Lorem ipsum fugiat!', likes_counter: 1,
    comments_counter: 1)
    @post_two = Post.create(author_id: @user.id, title: 'Rails is full of errors', text: 'Lorem ipsum fugiat!', likes_counter: 2,
    comments_counter: 0)
    @post_three = Post.create(author_id: @user.id, title: 'Hmmmmmm!', text: 'Lorem ipsum fugiat!', likes_counter: 3,
    comments_counter: 0)
  end
